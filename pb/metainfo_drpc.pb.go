...
type DRPCMetainfoClient interface {
	...
	FindObjectsByMetadata(ctx context.Context, in *FindObjectsByMetadataRequest) (*FindObjectsByMetadataResponse, error)
...
func (c *drpcMetainfoClient) FindObjectsByMetadata(ctx context.Context, in *FindObjectsByMetadataRequest) (*FindObjectsByMetadataResponse, error) {
	out := new(FindObjectsByMetadataResponse)
	err := c.cc.Invoke(ctx, "/metainfo.Metainfo/FindObjectsByMetadata", drpcEncoding_File_metainfo_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCMetainfoServer interface {
	...
	FindObjectsByMetadata(context.Context, *FindObjectsByMetadataRequest) (*FindObjectsByMetadataResponse, error)
...
func (s *DRPCMetainfoUnimplementedServer) FindObjectsByMetadata(context.Context, *FindObjectsByMetadataRequest) (*FindObjectsByMetadataResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCMetainfoDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 13:
		return "/metainfo.Metainfo/FindObjectsByMetadata", drpcEncoding_File_metainfo_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCMetainfoServer).
					FindObjectsByMetadata(
						ctx,
						in1.(*FindObjectsByMetadataRequest),
					)
			}, DRPCMetainfoServer.FindObjectsByMetadata, true
	case 14:
...
type DRPCMetainfo_FindObjectsByMetadataStream interface {
	drpc.Stream
	SendAndClose(*FindObjectsByMetadataResponse) error
}

type drpcMetainfo_FindObjectsByMetadataStream struct {
	drpc.Stream
}

func (x *drpcMetainfo_FindObjectsByMetadataStream) SendAndClose(m *FindObjectsByMetadataResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_metainfo_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
